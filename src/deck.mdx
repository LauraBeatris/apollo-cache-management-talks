...
### Let's see the steps with more details with the images provided on https://www.apollographql.com/blog/demystifying-cache-normalization/
...
# Assigning a unique identifier to each object by using the ``id`` and ``__typename``
