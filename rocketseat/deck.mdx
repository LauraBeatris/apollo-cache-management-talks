...
#### O cache é atualizado automaticamente se os resultados das mutations possuírem o **mesmo tipo** que os da query requisitada, a fim de recuperar o identificador único e mesclar os campos.
